...
const ServerDate = (function(serverNow) {
...
function setTarget(newTarget) {
  let message = "Set target to " + String(newTarget),
    delta;
...
function synchronize() {
  ...
  function requestSample() {
	...
	request.open("HEAD", "/?noCache=" + Date.now());
...
function log(message) {
    if (console && console.log && TIME_DEBUG) { console.log("[ServerDate] " + message); }
}
...
setInterval(function()
{
  ...
  // direction.
  const delta = Math.max(-ServerDate.amortizationRate,
